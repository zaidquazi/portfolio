...
export const projects: Project[] = [
  {
    ...
    isFlagship: true,
    name: "Talent Nexus",
    oneLiner: "A campus placement and recruitment platform built with React and Node.js. Students apply to jobs, recruiters manage pipelines, and admins oversee the full hiring workflow — all behind role-based access control.",
    ...
    slides: [
      ...
      },
      {
        ...
        image: "/images/talent-nexus/student-portal.png"
      },
      {
        ...
        category: "Admin View",
        tag: "Control Panel",
        image: "/images/talent-nexus/auth-flow.png"
      },
      {
  ...
  },
  {
    ...
    slides: [
      ...
      },
      {
        ...
        tag: "WebRTC / Stream",
        image: "/images/zashly/video-call.png"
      },
      {
        title: "Stories",
        ...
        category: "Stories",
        tag: "Ephemeral Media",
        image: "/images/zashly/stories.png"
      },
      {
        ...
        category: "Presence",
        tag: "Realtime State",
        image: "/images/zashly/presence.png"
      }
    ],
  ...
  },
  {
    ...
    isFlagship: false,
    name: "Home Town Hub",
    oneLiner: "A local business and community directory built with the MERN stack. Users discover businesses, browse events, and business owners can register their listing through an authenticated form.",
    role: "Full-Stack Developer",
    timeline: "2024",
    ...
    slides: [
      ...
      },
      {
        ...
        category: "Community",
        tag: "Events",
        image: "/images/home-town-hub/events.png"
      },
      {
        ...
        category: "Search",
        tag: "API Query",
        image: "/images/home-town-hub/search.png"
      },
      {
        ...
        category: "Owner Flow",
        tag: "Auth + Form",
        image: "/images/home-town-hub/owner-portal.png"
      }
    ],

    ...
    <Section id="contact" className={styles.contactSection} hasBorder={false} aria-label="Contact Section">
      <div className={styles.container}>
        ...
        <div className={styles.socialDock} aria-label="Professional Links">
          <a href={SEO.SOCIAL.GITHUB} target="_blank" rel="noopener noreferrer" className={styles.dockItem}>
          ...
          <a href={SEO.SOCIAL.LINKEDIN} target="_blank" rel="noopener noreferrer" className={styles.dockItem}>
          ...
          <a href="/resume.png" target="_blank" rel="noopener noreferrer" className={styles.dockItem}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
            <span>Resume</span>
          </a>
          <a href={`${SEO.SOCIAL.GITHUB}/portfolio`} target="_blank" rel="noopener noreferrer" className={styles.dockItem}>
          ...
          <a href={SEO.PROJECTS.ZASHLY.URL} target="_blank" rel="noopener noreferrer" className={styles.dockItem}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>
            <span>Zashly</span>
          </a>
          <a href={SEO.PROJECTS.ZASHIO.URL} target="_blank" rel="noopener noreferrer" className={styles.dockItem}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>
            <span>Zashio</span>
          </a>
          <a href={SEO.PROJECTS.ZASHUB.URL} target="_blank" rel="noopener noreferrer" className={styles.dockItem}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>
            <span>Zashub</span>
          </a>
        </div>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerContent}>
          <span className={styles.copyright}>© {new Date().getFullYear()} {SEO.PERSON_NAME}.</span>

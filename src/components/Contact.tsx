    ...
    <Section id="contact" className={styles.contactSection} hasBorder={false} aria-label="Contact Section">
      <div className={styles.container}>
        ...
        <div className={styles.socialDock} aria-label="Professional Links">
          <a href="https://github.com/zaidquazi" target="_blank" rel="noopener noreferrer" className={styles.dockItem}>
          ...
          <a href="https://github.com/zaidquazi/portfolio" target="_blank" rel="noopener noreferrer" className={styles.dockItem}>
